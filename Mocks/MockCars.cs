        ...
        public IEnumerable<Car> Cars {
            get
            {
                return new List<Car>
                {
                    ...
                    new Car { Name = "BMW M3", ShortDescription = "Bold and stylish", LongDescription = "A stylish and comfortable car for city driving", Image = "/img/bmv.jpg", Price = 65000, IsFavorite = true, Available = true, Category = _categoryCars.AllCategories.Last() },
